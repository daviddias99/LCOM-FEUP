...
#define NUM_MAPPED_KEYS 58 /**< Size of the array that contains the mapped keys */
...
/**
 * @brief Returns the char correspondent to the scancode. If the scancode is not mapped returns the null char. Takes into account the caps lock and the shift keys.
 * 
 * @param sc_byte 
 * @return char 
 */
...
/**
 * @brief Clears the kbc's outbuffer to avoid left over bytes after interrupt unsubscribing
 * 
...
/**
 * @brief Check if the caps lock is on or of
 * 
